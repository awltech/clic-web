...
public class CommandRegistry {
	 ...
	 * contributed and store them into a {@link java.util.Map}
	 */
	...
	/**
	 * This {@link java.util.Map} allows to store all the commands which have been
	 * contributed through the extension point. The {@link java.util.Map} is linked a
	...
	/**
	 * This {@link java.util.Map} allows to store all the flows which have been
	 * contributed through the extension point. The {@link java.util.Map} actually links
	...
	/**
	 * Allows to search the registry {@link java.util.Map} ({@link #commands}) for a
	 * particular command by its id. If the command exists, the
	 * {@link CommandWrapper} will allow to actually create the
	 * {@link jenkins.plugins.clic.commands.AbstractCommand} object.
	 * 
	 *
     *
     * @param commandId
     *            the id of the command you'd like to search in the registry
     * @return an instance of {@link jenkins.plugins.clic.commands.AbstractCommand} linked to the specified id
	...
	/**
	 * Allows to search the registry {@link java.util.Map} ({@link #commands}) for the
	 ...
	 * 
	 * @return A {@link java.util.Set} containing all the available commands ids. The
