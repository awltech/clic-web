 ...
 */
package jenkins.plugins.clic.internal;

import com.google.common.collect.ObjectArrays;
import jenkins.plugins.clic.commands.AbstractCommand;
import jenkins.plugins.clic.commands.CommandContext;
import joptsimple.OptionException;

import java.util.ArrayList;
import java.util.StringTokenizer;

import static jenkins.plugins.clic.commands.ClicMessages.*;
...
public class CommandProcessor {
	...
	/**
	 * {@link #context} contains the {@link jenkins.plugins.clic.commands.CommandContext} to be used during
     ...
     *
     *
     * Warning : is now public maybe go by a scheduler or else ? Job ?
	 */
	public void run() {
	...
	/**
	 * This {@link #processCommand(String, jenkins.plugins.clic.commands.CommandContext)} function allows to
...
*/			}
	...
	/**
	 * This internal function allows to invoke the {@link joptsimple.OptionParser} of a
	 * specific provided {@link jenkins.plugins.clic.commands.AbstractCommand} in order to compute all of its
	 * parameters.
	 *
	 * @param commandImplementation
	 *            an {@link jenkins.plugins.clic.commands.AbstractCommand} on which we want to compute the
	 *            options
	 * @param context
	 *            the execution's context
	 * @param parameters
	 *            all the parameters to be computed by the {@link joptsimple.OptionParser}
	 * 
	 * @see jenkins.plugins.clic.commands.AbstractCommand#parse(String[])
	 */
	 ...
	 * 
	 * @throws CommandProcessor.CommandParsingException
	 */
