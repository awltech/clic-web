...
/**
 * The {@link com.worldline.clic.internal.commands.CommandFlowWrapper} object allows to store all the information
...
public class CommandFlowWrapper {
	...
	/**
	 * A {@link java.util.List} containing all the commands to be invoked by the flow
	 */
