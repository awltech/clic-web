 ...
 * are linked to a command, and build the instance of {@link jenkins.plugins.clic.commands.AbstractCommand} to
 * be linked to the command when needed.
 * 
 * A {@link CommandWrapper} object will be created for each entry of the
 * extension point, and will allow to create the {@link jenkins.plugins.clic.commands.AbstractCommand} only
 * when needed.
 * 
...
public class CommandWrapper {
	 ...
	 * @param element
	 *            the {@link Object} coming directly from the
	 *            extension point
	 */
	...
	/**
	 * Allows to create the {@link jenkins.plugins.clic.commands.AbstractCommand} instance which is linked to
	 * this {@link CommandWrapper}. It'll use the information coming from the
	 * extension point in order to get the executable.
	 * 
	 * @return an instance of {@link jenkins.plugins.clic.commands.AbstractCommand} linked to this
	 *         {@link CommandWrapper}, null if an error is raised
	 */
	public AbstractCommand createCommand() {
		try {
			/*final AbstractCommand cmd = (AbstractCommand) element.createExecutableExtension("implementation");
