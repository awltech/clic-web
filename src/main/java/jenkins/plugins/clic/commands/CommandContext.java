...
public class CommandContext {
	 ...
	 * 
	 * @param writer
	 *            the {@link java.io.Writer} object to be used by CLiC in order to send
	 *            data to the console
	 */
	...
	/**
	 * The {@link java.io.Writer} object which is used internally by the console in
	...
	/**
	 * This {@link #context} object is actually a {@link java.util.Map} allowing to store
	 ...
	 * after yours. You can write any arguments directly in this {@link java.util.List},
	 ...
	 * 
	 * @return {@link #context} a {@link java.util.Map} containing the execution's context
	 *         data
	 */
	 ...
	 * command
	 * 
	 * @return {@link #outputs} which is a {@link java.util.List} of {@link String}
