...
/**
 * This {@link com.worldline.clic.internal.ClicMessages} enum allows actually to get i18n messages from a
 * properties file. It uses internally a {@link java.util.ResourceBundle} which is linked
 ...
 * {@link java.text.MessageFormat#format(String, Object...)} internally.
 * 
 * @author aneveux
 * @version 1.0
 * @since 1.0
...
public enum ClicMessages {
	...
	/**
	 * {@link java.util.ResourceBundle} instance to be used to get messages
	 */
