 ...
 */
package jenkins.plugins.clic.commands.mvn;
...
import static jenkins.plugins.clic.commands.mvn.ClicMavenMessages.*;


public class MavenCommand extends AbstractCommand {

	/**
	 * This {@link org.apache.maven.shared.invoker.InvocationRequest} will actually be enriched while computing
	...
	/**
	 * This {@link joptsimple.OptionSpec} contains all the Maven parameters provided using
	 * the syntax <code>-Dparam=value</code>
	 */
	private OptionSpec<KeyValuePair> mavenParameters;

	/**
	 * This {@link joptsimple.OptionSpec} contains the Maven reference which is provided by
	 * the user using the format <code>groupId:artifactId:version</code>
	 */
	private OptionSpec<String> mavenReference;

	/**
	 * This {@link joptsimple.OptionSpec} contains the Maven command which should be
	 ...
	 * @param reference
	 *            the {@link MavenCommand.MavenReference} to be used for generating the
	 *            command
	 */
	...
	/**
	 * Custom {@link org.apache.maven.shared.invoker.InvocationOutputHandler} allowing to write the execution
